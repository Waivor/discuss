...
$_lang['discuss.menu_desc'] = 'Ein dynamisches auf Themen basierendes Forum.';

$_lang['discuss.access'] = 'Zugang';
$_lang['discuss.action'] = 'Aktion';
$_lang['discuss.active'] = 'Aktiv';
$_lang['discuss.activity_log'] = 'Aktivitätsprotokoll';
$_lang['discuss.activity_log.intro_msg'] = 'Ein Protokoll aller in den Foren durchgeführten Moderator- und Administrator-Aktionen';
$_lang['discuss.activity_log_remove'] = 'Log-Eintrag entfernen';
$_lang['discuss.activity_log_remove_confirm'] = 'Möchten Sie diesen Protokolleintrag dauerhaft entfernen?';
$_lang['discuss.admin'] = 'Administrator';
$_lang['discuss.archived'] = 'Archiviert';
$_lang['discuss.board'] = 'Board';
$_lang['discuss.board_category_desc'] = 'Angabe der Kategorie, in der sich das Board befindet';
$_lang['discuss.board_collapsible'] = 'Zusammenklappbar';
$_lang['discuss.board_collapsible_desc'] = 'Falls aktiviert, können Benutzer die Karte zusammenklappen, um deren Inhalt zu verstecken.';
$_lang['discuss.board_create'] = 'Board erstellen';
$_lang['discuss.board_create_here'] = 'Erstelle ein Board hier';
$_lang['discuss.board_description_desc'] = 'Eine kurze Beschreibung des Boards, die unter den Titel gesetzt angezeigt wird.';
$_lang['discuss.board_edit'] = 'Board bearbeiten';
$_lang['discuss.board_err_nf'] = 'Board mit der id [[+id]] konnte nicht gefunden werden.';
$_lang['discuss.board_err_ns'] = 'Board nicht angegeben';
$_lang['discuss.board_err_ns_category'] = 'Bitte wählen Sie eine Kategorie für dieses Board aus.';
$_lang['discuss.board_err_ns_name'] = 'Bitte geben Sie einen gültigen Namen für dieses Board ein.';
$_lang['discuss.board_err_remove'] = 'Beim Versuch, das Board zu entfernen, ist ein Fehler aufgetreten.';
$_lang['discuss.board_err_save'] = 'Beim Versuch, das Board zu speichern, ist ein Fehler aufgetreten.';
$_lang['discuss.board_ignoreable'] = 'Ignorierbar';
$_lang['discuss.board_ignoreable_desc'] = 'Wenn aktiviert, können Benutzer dieses Board in ihrer Ansicht verstecken.';
$_lang['discuss.board_locked'] = 'Gesperrt';
$_lang['discuss.board_locked_desc'] = 'Wenn aktiviert, können nur Administratoren auf diesem Board posten.';
$_lang['discuss.board_moderators_msg'] = 'Dies ist eine Liste aller Moderatoren für dieses aktuelle Board.';
$_lang['discuss.board_name_desc'] = 'Ein Name für das Board.';
$_lang['discuss.board_merge'] = 'Board zusammenführen';
$_lang['discuss.board_merge.boardaction'] = 'Board Aktion';
$_lang['discuss.board_merge.merge_into'] = 'Board zusammenführen mit';
$_lang['discuss.board_merge.name'] = 'Board zum Zusammenführen';
$_lang['discuss.board_merge.start'] = 'Starten des Zusammenführungsvorgangs ...';
$_lang['discuss.board_merge.remove'] = 'Board löschen';
$_lang['discuss.board_merge.deactivate'] = 'Board als inaktiv markieren';
$_lang['discuss.board_merge.archive'] = 'Board archivieren';
$_lang['discuss.board_merge.nothing'] = 'Nichts tun';
$_lang['discuss.board_new'] = 'Neues Board';
$_lang['discuss.board_remove'] = 'Board löschen';
$_lang['discuss.board_remove_confirm'] = 'Sind Sie sicher, dass Sie dieses Board und alle seine Subboards vollständig entfernen möchten?';
$_lang['discuss.board_status'] = 'Status';
$_lang['discuss.board_status_desc'] = 'Der Status des Boards: Aktive Boards werden angezeigt und offen. Inaktive Karten werden nicht angezeigt. Archivierte Boards werden nur angezeigt.';
$_lang['discuss.board_usergroup_add'] = 'Benutzergruppenzugriff für dieses Board hinzufügen';
$_lang['discuss.board_usergroup_remove'] = 'Benutzergruppe entfernen';
$_lang['discuss.board_usergroup_remove_confirm'] = 'Möchten Sie dieser Benutzergruppe den Zugriff zu diesem Board wirklich entziehen?';
$_lang['discuss.board_usergroup_remove_title'] = 'Benutzergruppenzugriff entfernen?';
$_lang['discuss.board_usergroups_msg'] = 'Dies ist eine Liste aller Benutzergruppen, die auf dieses aktuelle Board zugreifen können. Wenn keine angegeben sind, ist das Board öffentlich zugänglich.';
$_lang['discuss.boards'] = 'Boards';
$_lang['discuss.boards.intro_msg'] = 'Verwalten Sie alle Boards für Ihr Forum. Zuerst erstellen Sie eine Kategorie für jedes Board. Anschließend können Sie Boards (und Sub-Boards) innerhalb der Kategorie erstellen. Sie können auch Bretter ziehen und fallen lassen, um sie neu zu ordnen.';
$_lang['discuss.categories'] = 'Kategorien';
$_lang['discuss.category'] = 'Kategorie';
$_lang['discuss.category_create'] = 'Kategorie erstellen';
$_lang['discuss.category_default_moderators'] = 'Gängige Board Moderatoren';
$_lang['discuss.category_default_moderators_desc'] = 'Eine durch Kommas getrennte Liste von Moderator-Benutzernamen, die automatisch zu neuen Boards in dieser Kategorie hinzugefügt werden sollen. Leer lassen, sofern die Option nicht benötigt wird.';
$_lang['discuss.category_default_usergroups'] = 'Gängige Board Benutzer Gruppen';
$_lang['discuss.category_default_usergroups_desc'] = 'Eine kommagetrennte Liste von Benutzergruppennamen, die automatisch zu neuen Boards in dieser Kategorie hinzugefügt werden, wodurch das jeweilige Board gleichzeitig für die angegebenen Benutzergruppen exklusiv wird. Leer lassen, sofern die Option nicht benötigt wird.';
$_lang['discuss.category_description_desc'] = 'Eine kurze Beschreibung der Kategorie';
$_lang['discuss.category_edit'] = 'Kategorie bearbeiten';
$_lang['discuss.category_err_ae'] = 'Es existiert bereits eine Kategorie mit diesem Namen.';
$_lang['discuss.category_err_nf'] = 'Kategorie mit der id [[+id]] konnte nicht gefunden werden.';
$_lang['discuss.category_err_ns'] = 'Bitte geben Sie eine Kategorie an.';
$_lang['discuss.category_err_ns_name'] = 'Bitte geben Sie einen gültigen Namen ein.';
$_lang['discuss.category_err_remove'] = 'Beim Versuch, die Kategorie zu entfernen, trat ein Fehler auf.';
$_lang['discuss.category_err_save'] = 'Beim Speichern der Kategorie ist ein Fehler aufgetreten.';
$_lang['discuss.category_name_desc'] = 'Ein Name für die Kategorie';
$_lang['discuss.category_remove'] = 'Kategorie entfernen';
